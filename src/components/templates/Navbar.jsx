...
export const Navbar = () => {
  return (
    <nav className="fixed w-full">
      ...
      <div className="flex flex-row gap-4 items-center bg-[#0e1111] text-white font-semibold text-lg h-12 py-4 w-auto lg:max-w-5xl px-5 lg:px-0 lg:mx-auto shadow-lg">
        <Link
