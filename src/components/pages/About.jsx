  ...
  return (
    <header id="about">
      <div className="flex flex-col-reverse md:flex-row gap-5 justify-around items-center px-5 lg:px-0 pb-8 pt-20 md:pt-40">
        <div>
          ...
          <p className="font-ghaly text-base pb-3 text-[#d3d4d6] ">
            Hello, I'm Ghaly. I am a final-semester physics student enthusiastic
            about research, teaching, programming, and design activities to
            build visually attractive applications with user-friendly
            interactions.{" "}
          </p>
          <p className="font-ghaly text-base pb-4 text-[#d3d4d6] ">
            ...
            complex problems and make a positive impact on people's lives. So, I
            ...
            various learning resources such as YouTube, Coursera, and the
          ...
          <p className="font-ghaly text-base pb-4 text-[#d3d4d6] ">
            ...
            collaborating with small teams and big teams by getting feedback to
      ...
      <div>
        ...
        <div className="flex lg:flex-row items-center gap-2 mt-1">
